...
public class IntegrationTestSupport {
    ...
    public void cleanup() {
        ...
        Class listClass = getCustomResourceListClass(controller);
        ...
        await("all config maps cleaned up").atMost(60, TimeUnit.SECONDS)
                .untilAsserted(() -> {
                    assertThat(k8sClient.configMaps().inNamespace(TEST_NAMESPACE).withLabelNotIn("istio.io/config").list().getItems().isEmpty());
                });
